...
function drawLightCone(scene, ctx){
    ...
    ctx.beginPath();
    ctx.moveTo(0,0);
    ctx.lineTo(0, size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0], size * ycoeff + scene.origin[2]);
    ctx.lineTo( size *xcoeff+ scene.origin[0], -size * ycoeff + scene.origin[2]);
    ctx.lineTo( scene.mWidth, -size * ycoeff + scene.origin[2]);
    ctx.lineTo( scene.mWidth, size * ycoeff + scene.origin[2]);
    ctx.lineTo( size *xcoeff+ scene.origin[0], size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0], -size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0], -size * ycoeff + scene.origin[2]);
    ...
    ctx.lineTo( size *xcoeff+ scene.origin[0], -size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0],  size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0],scene.mHeight);
    ctx.lineTo(size *xcoeff+ scene.origin[0],scene.mHeight);
    ctx.lineTo( size *xcoeff+ scene.origin[0],  size * ycoeff + scene.origin[2]);
    ctx.lineTo(-size *xcoeff+ scene.origin[0], -size * ycoeff + scene.origin[2]);
    ctx.closePath();
